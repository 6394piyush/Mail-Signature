...
var elementsinputinformation = [
    ...
    document.getElementById("inputofficephone"),
    document.getElementById("inputfax"),
    document.getElementById("inputaddresslineone"),
    document.getElementById("inputaddresslinetwo"),
    document.getElementById("inputwebsite")
];

var elementsinputsize = [
    document.getElementById("inputnamesize"),
    document.getElementById("inputtitlesize"),
    document.getElementById("inputemailsize"),
    document.getElementById("inputmobilesize"),
    document.getElementById("inputcompanynamesize"),
    document.getElementById("inputofficephonesize"),
    document.getElementById("inputfaxsize"),
    document.getElementById("inputaddresslineonesize"),
    document.getElementById("inputaddresslinetwosize"),
    document.getElementById("inputwebsitesize")
];


var elementsoutputinformation = [
...
var layoutdefault = {
    "layoutbasicinformation": "margin-left: 90px; padding-top: 35px;",
    "layoutcompanyinformation": "margin-top: 15px; text-align: center;",
    "layoutcontactinformation": "margin-top: 20px; margin-left: 90px;",
    "layoutlogo": "position: absolute; top: 0px; left: 0;",
    "logouser": "position: absolute; top: 0px; right: 0px;",
    "logocompany": "position: absolute; bottom: 46px; left: 0; width: 100%; text-align: center;",
    "layoutbanner": "position: absolute; bottom: -4px; padding: 0;"
};

var layoutright = {
    "layoutbasicinformation": "margin-left: 10px; padding-top: 35px;",
    "layoutcompanyinformation": "margin-top: 10px; margin-left: 90px;",
    "layoutcontactinformation": "margin-top: 20px; margin-left: 20px;",
    "layoutlogo": "position: absolute; top: 0%; right: 0px;",
    "logouser": "position: absolute; top: 0px; left: 0px;",
    "logocompany": "position: absolute; bottom: 46px; left: 0; width: 100%; text-align: center;",
    "layoutbanner": "position: absolute; bottom: -4px; padding: 0;"
};
...
function applyLayout(layout) {
    document.getElementById("layoutbasicinformation").setAttribute("style", layout.layoutbasicinformation);
    document.getElementById("layoutcompanyinformation").setAttribute("style", layout.layoutcompanyinformation);
    document.getElementById("layoutcontactinformation").setAttribute("style", layout.layoutcontactinformation);
    document.getElementById("layoutlogo").setAttribute("style", layout.layoutlogo);
    document.getElementById("logouser").setAttribute("style", layout.logouser);
    document.getElementById("logocompany").setAttribute("style", layout.logocompany);
    document.getElementById("layoutbanner").setAttribute("style", layout.layoutbanner);
}
...
function updateSignatureText(element) {
   
    var targetelement = element.id.substring(5);
    var output = "";
    switch (targetelement) {
        ...
        case "fax":
            ...
            break;
        case "website":
            document.getElementById("websitelink").setAttribute("href", element.value);
            document.getElementById("logolink").setAttribute("href", element.value);
            document.getElementById("companylink").setAttribute("href", element.value);
            break;
        case "email":
            document.getElementById("emaillink").setAttribute("href", "mailto:" + element.value);
            break;
    }
    output += element.value;
    
    document.getElementById(targetelement).innerHTML = output;
}

function universallyUpdateSignatureText(element) {
    for (var i = 0; i < elementsinputinformation.length; i++) {
        elementsinputinformation[i].value = element.value;
        updateSignatureText(elementsinputinformation[i]);
    }
}

function updateSignatureTextSize(elementid, value) {
    document.getElementById(elementid).style.fontSize = value + "px";
}

function universallyUpdateSignatureTextSize(value) {
    for (var i = 0; i < elementsinputinformation.length; i++) {
        elementsinputsize[i].value = value;
        updateSignatureTextSize(elementsoutputinformation[i].id, value);
    }
}

function updateSignatureLogo(element, type) {
    ...
    if (element.value.trim() !== "") {
        ...
        if (document.getElementById(elementid + "link") === null)
            CreateElements(element.value, type, elementid + "image", data, type, elementid + "link");
        else
            document.getElementById(elementid + "link").setAttribute("href", element.value);
    }
    else {
        var e;
        if ((e = document.getElementById(elementid + "link")) !== null) {
...
function CodeToShow() {
    var codetoshow = document.getElementById("right").innerHTML;
    codetoshow = replaceAll(codetoshow, "<", "&lt");
    codetoshow = replaceAll(codetoshow, ">", "&gt");
    document.getElementById("CodeFetch").innerHTML = "<pre>" + codetoshow + "</pre>";
}
...
function ChangeTheme(value) {
    switch (value) {
        ...
        {
        applyLayout(layoutdefault);
        }
        case "Logo Aligned Right":
        {
            applyLayout(layoutright);
...
function ColorPicker(elementid, color) {
...
function SizeChange(whose, value) {
    switch (whose) {
        ...
        case "Logoss":
        {
            ...
            var logo = document.getElementsByClassName("logocompany");
            for (i = 0; i <= logo.length; i++) {
                logo[i].height = value;
                logo[i].width = value;
            }
...
function ChangeStyle(value,Class){
   
     var logo=document.getElementsByClassName(Class);
    
         for(i=0;i<=logo.length;i++)
         { 
           logo[i].style.borderRadius=value;
         }
}
 
function ChangeFont(value){
   var text=document.getElementById("style-preview");
